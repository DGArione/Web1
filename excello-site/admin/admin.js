...
(function () {
  ...
  var SITE_FIELDS = [
    ...
    { k: "__stats", label: "Home page — statistics row (number + label)", type: "heading" },
    { k: "stat1Num", label: "Stat 1 — number (e.g. 44)" },
    { k: "stat1Label", label: "Stat 1 — label (e.g. Residences at Aathavan)" },
    { k: "stat2Num", label: "Stat 2 — number" },
    { k: "stat2Label", label: "Stat 2 — label" },
    { k: "stat3Num", label: "Stat 3 — number" },
    { k: "stat3Label", label: "Stat 3 — label" },
    { k: "stat4Num", label: "Stat 4 — number" },
    { k: "stat4Label", label: "Stat 4 — label" },
